CREATE TABLE ethereum_transfers.transfers_cohort_1_2024_1123  -- needs to be changed
PARTITION BY date
...
transfers_filtered AS (
    ...
    WHERE CAST(block_timestamp AS DATE) BETWEEN '2024-09-26' AND '2024-11-23'  -- needs to be changed
),
transfers AS (
    -- receipts (positive)
